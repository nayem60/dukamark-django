                        ...
                        <div class="product__details-content">
                            ...
                            {% if product.id|size %}
                              <div class="mb-4">
                               ...
                               <button onclick="size({{ size.size.id }},{{ size.id }}) "class="btn btn-ligth btn-sm border rounded mr-5 size-link color_{{ size.color.id }}" id="size_{{ size.size.id }}" data-price="{{ size.price }}">{{ size.size.name }}</button>
                               {% endfor %}
                              </div>
                            {% endif %}
                            ...
                            <div class="mb-4">
                               ...
                               <button onclick="color({{ color.color.id }},{{ color.id }})"class="btn btn-ligth btn-sm border rounded mr-5 color-link choose-color size_{{ color.size.id }}" id="color_{{ color.color.id }}" data-prices="{{ color.price }}">{{ color.color.name }}</button>
                               {% endfor %}
                              </div>
                            {% endif %}
                            ...
                            <div class="cart-option mb-15">
                                ...
                                <a href="javascript:void(0)" onclick="addCart({{ product.id }})" class="cart-btn">Add to Cart</a>
                            </div>
                ...
                <div class="tab-content" id="prodductDesTaContent">
                    ...
                    <div class="tab-pane fade" id="aditional" role="tabpanel" aria-labelledby="aditional-tab">
                        <div class="product__desc-info">
                            <ul>
                            {% for specification in product.specification.all %}
                               <li>
                                  <h6>{{ specification.attribute }}</h6>
